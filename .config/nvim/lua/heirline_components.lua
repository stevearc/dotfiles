...
local function setup_colors()
  return {
    ...
    bright_fg = utils.get_highlight("Folded").fg or "none",
    red = utils.get_highlight("DiagnosticError").fg or "none",
    dark_red = utils.get_highlight("DiffDelete").bg or "none",
    yellow = utils.get_highlight("DiagnosticWarn").fg or "none",
    green = utils.get_highlight("String").fg or "none",
    blue = utils.get_highlight("Function").fg or "none",
    gray = utils.get_highlight("NonText").fg or "none",
    orange = utils.get_highlight("Constant").fg or "none",
    purple = utils.get_highlight("Statement").fg or "none",
    cyan = utils.get_highlight("Special").fg or "none",
    ...
    diag_hint = utils.get_highlight("DiagnosticHint").fg or "none",
    diag_info = utils.get_highlight("DiagnosticInfo").fg or "none",
    git_del = utils.get_highlight("DiffDelete").fg or "none",
    git_add = utils.get_highlight("DiffAdd").fg or "none",
    git_change = utils.get_highlight("DiffChange").fg or "none",
  }
end
