...
globalkeys = gears.table.join(
    ...
    awful.key({ altkey, "Shift"   }, "Return", function () awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher"}),
    ...
    awful.key({ altkey, "Shift" },            "r",     function () awful.util.spawn("dmenu_run -i -l 10") end,
              {description = "run prompt", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ altkey            }, "w",      function (c) c:kill()                         end,
